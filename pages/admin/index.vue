                ...
                <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div class="flex items-center lg:order-2">
                        <a href="login"
                            ...
                            in</a>
                        <a href="register"
                            class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Register</a>
                    ...
                    <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                        <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            ...
                            <li>
                                <a href="order"
                                    class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Data
                                    Order</a>
                            </li>
                            <li>
                                <a href="customer"
            ...
            <div class="grid py-8 px-4 mx-auto max-w-screen-xl lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div class="place-self-center mr-auto lg:col-span-7">
                    <h1 class="mb-4 max-w-2xl text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl dark:text-white">
                        Service-Expert</h1>
                    <p class="mb-5 max-w-2xl font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                        Service-Expert adalah layanan yang menyediakan solusi terbaik untuk semua masalah teknis Anda.
                        Kami adalah ahli dalam bidang ini dan siap membantu Anda dengan kebutuhan teknis Anda, baik itu
                        untuk bisnis maupun untuk kebutuhan pribadi Anda.
                    </p>
                    <a href="#"
        ...
        <section class="bg-gray-50 dark:bg-gray-800">
            <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div class="mb-8 max-w-screen-md lg:mb-16">
                    <h2 class="mb-4 text-4xl font-extrabold text-gray-900 dark:text-white">Fitur - Fitur yang disediakan oleh Service-Expert</h2>
                    <p class="text-gray-500 sm:text-xl dark:text-gray-400">Service-Expert adalah Membangun sistem aplikasi jasa service yang mempermudah customer
                        dalam mendapatkan layanan service dalam hal meningkatkan kualitas layanan jasa.</p>
                </div>
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 class="mb-4 text-4xl font-extrabold text-gray-900 dark:text-white">Testimoni dari Customer</h2>
                    <p>Service-Expert adalah Membangun sistem aplikasi jasa service yang mempermudah customer dalam mendapatkan layanan service dalam hal meningkatkan kualitas layanan jasa. Salah satunya yaitu:</p>
                        <p>1. Meningkatkan efisiensi dalam pencarian dan memanggil jasa servis.</p>
                        <p>2. Mempermudah dalam mempertimbangkan dan memilih jasa servis yang sesuai dengan keadaannya.</p>
                        <p>3. Membangun chatbot untuk meningkatkan efisiensi waktu dalam hal menjawab pertanyaan dari customer.</p>
                </div>
